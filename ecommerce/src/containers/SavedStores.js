            ...
            <section className={styles.bigSection}>
                <div className={styles.bar}>
                    <ul>
                        ...
                        <li><a href="findnearbystores">Find nearby stores</a></li>
                        <li><a href="savedstores">Saved Stores</a></li>
                        <li><a href="recentstores">Recent Stores</a></li>
                    </ul>
                </div>
                <div className={styles.largeCard}>
                    <div className={styles.card}>
                        <div className={styles.shoprite}>
                            <a href="shoprite"><h6>Shoprite</h6></a>
                            <img src={F2} alt="Shop" />
                        </div>
                        <div className={styles.ipsum}>
                            <h2>Lorem ipsum</h2>
                            <h3>Location: dolor sit amet, consectetur adipiscin </h3>
                            <svg
                                width="112"
                                height="22"
                                viewBox="0 0 112 22"
                    ...
                    <div className={styles.card2}>
                        <div>
                            <a href="skymall"><h6>Skymall</h6></a>
                            <img src={F3} alt="Shop" />
                        </div>
                        <div className={styles.ipsum2}>
                            <h2>Lorem ipsum</h2>
                            <h3>Location: dolor sit amet, consectetur adipiscin </h3>
                            <svg
                                width="112"
                    ...
                    <div className={styles.card3}>
                        <div>
                            <a href="spar"><h6>Spar</h6></a>
                            <img src={F4} alt="Shop" />
                        </div>
                        <div className={styles.ipsum3}>
                            <h2>Lorem ipsum</h2>
                            <h3>Location: dolor sit amet, consectetur adipiscin </h3>
                            <svg
                                width="112"
                    ...
                    <div className={styles.card4}>
                        <div>
                            <a href="addidasmall"><h6>Addidas Mall</h6></a>
                            <img src={F5} alt="Shop" />
                        </div>
                        <div className={styles.ipsum4}>
                            <h2>Lorem ipsum</h2>
                            <h3>Location: dolor sit amet, consectetur adipiscin </h3>
                            <svg
                                width="112"
